...
/**
* \def MBEDTLS_ECDSA_SECP256r1_SHA256
*
...
*
* Enable the support for the ECDSA_SECP384r1_SHA384
* signature scheme
*
* Requires: MBEDTLS_ECP_DP_SECP384R1_ENABLED, ...
*
...
/**
* \def MBEDTLS_ECDSA_SECP521r1_SHA512
*
* Enable the support for the ECDSA_SECP521r1_SHA512
* signature scheme
*
* Requires: MBEDTLS_ECP_DP_SECP521R1_ENABLED, ...
*
...
*      MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256
*      MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256
*      MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CCM_SHA384
...
* RFC 6347 4.2.4.1 says from 1 second (1000 ms) to 60 (60000 ms) seconds.
* The DTLS/TLS IOT profile in RFC 7925 recommends an initial timer value
...
* and/or this and MBEDTLS_SSL_PROTO_TLS1_3 to enable DTLS 1.3.
*
* Requires: MBEDTLS_SSL_PROTO_TLS1_1
*        or MBEDTLS_SSL_PROTO_TLS1_2
*        or MBEDTLS_SSL_PROTO_TLS1_3
*
...
*
* Enable the SHA-512 and SHA-384 cryptographic hash algorithms.
*
...
*
* Enable basic implementation of cookies
* (used in DTLS HelloVerify and TLS 1.3 HelloRetryRequest msg)
*
