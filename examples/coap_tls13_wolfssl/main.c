 ...
 *
 * @file
 * @brief       Demonstrating ATLS 1.3 using WolfSSL
 *
...
static const shell_command_t shell_commands[] = {
    { "tlsc", "ATLS 1.3 Client example", start_tls_client },
    { "tlss", "ATLS 1.3 Server example", start_tls_server },
    { NULL, NULL, NULL }
};
